    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right"><form action="<?php echo site_url('disposisi/index'); ?>" class="form-inline" method="get" style="margin-top:10px">
		...
		<td  style="width: 10px;padding-left: 8px;"><input type="checkbox" name="id" value="<?= $disposisi->id;?>" />&nbsp;</td>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('disposisi/read/'.$disposisi->id),'<i class="fa fa-search"></i>', 'class="btn btn-xs btn-primary"  data-toggle="tooltip" title="Detail"'); 
				echo ' '; 
				echo anchor(site_url('disposisi/update/'.$disposisi->id),' <i class="fa fa-edit"></i>', 'class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"'); 
				echo ' '; 
				echo anchor(site_url('disposisi/delete/'.$disposisi->id),' <i class="fa fa-trash"></i>','class="btn btn-xs btn-danger" onclick="javasciprt: return confirmdelete(\'disposisi/delete/'.$disposisi->id.'\')"  data-toggle="tooltip" title="Delete" '); 
				?>
			</td>
		</tr>
                <?php
