  ...
  <div class="wrapper">
    ...
    <footer class="main-footer">
      <div class="pull-right hidden-xs">
        <b>Developed by<a href="https://Fajarsomantri.com"> Fajar Somantri</b></a>
      </div>
      <strong>Copyright &copy; <?= date('Y'); ?> <a href="https://Fajarsomantri.com">Sistem Surat</a>.</strong> All rights
      reserved.
