    ...
    <div class="box">
      ...
      <div class="box-body">
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('surat_keluar/create'),'<i class="fa fa-plus"></i> Create', 'class="btn bg-purple"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right"><form action="<?php echo site_url('surat_keluar/index'); ?>" class="form-inline" method="get" style="margin-top:10px">
