    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="row" style="margin-bottom: 10px;margin-left:10px">
          <form action="<?php echo base_url('laporan/laporan_surat_keluar'); ?>" class="form-inline" method="post">
            ...
            <div class="col input-group">
              ...
              <a href="<?= base_url('laporan/laporan_sk_print'); ?>" class="btn btn-success"> <i class="fas fa-file-alt"></i> Excel</a>
            </div>
          </form>
        </div>
            ...
            <table class="table table-hover" style="margin-bottom: 10px" style="width:100%">
              ...
              ?>
                ...
                <tr>
                  ...
                  <td><strong><?php echo $surat_keluar->pengirim ?></strong></td>
                  <td><?php echo $surat_keluar->tanggal_surat ?></td>
                  <td><a href="<?php echo base_url('assets/uploads/files/surat/surat_keluar/' . $surat_keluar->file_surat)  ?>"><?= $surat_keluar->file_surat; ?></a></td>
