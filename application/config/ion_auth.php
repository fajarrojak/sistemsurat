 ...
 */
$config['site_title']                 = "sistemsurat";       // Site Title, example.com
$config['admin_email']                = "-"; // Admin Email, admin@example.com
$config['default_group']              = 'koordinator';           // Default group, use name
$config['admin_group']                = 'kapus';             // Default administrators group, use name
